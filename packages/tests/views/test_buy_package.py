...
class BuyPackageTests(ViewsTests):
    ...
    def test_buy_package_post(self):
        ...
        self.assertEqual('Package purchased successfully. You may <strong><a href=/captive/?login_url=https://n110.network-auth.com/splash/login?mauth=MMNsInqn8ksWBR7PgbfBkWG8PawzJm1wi4PE9pDEUdU1qFuHtYczZmRJFJ3dD7AJvl9DRppZnJAZOTA7L3KbzaX4WgwU74t5ibpIJBwHJ-eg5RnL4Hct5hs7i1UIRBH6kbeL9X4hlcFLZKvkaV2mpeP_hX9hxs5jGl_C0N6oWtoQtUjskrMcnBaA&continue_url=http%3A%2F%2Fgoogle.com%2F&continue_url=http://google.com/&ap_mac=00:18:0a:f2:de:20&ap_name=Spectra-HQ-NOC&ap_tags=office-accra recently-added&client_mac=4c:eb:42:ce:6c:3d&client_ip=10.8.0.78>log in</a></strong> to browse.', lst[0].__str__())
